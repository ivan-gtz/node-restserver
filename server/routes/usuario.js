...
app.get('/usuario', verificaToken, function (req, res) {
    ...
    Usuario.find(estadoActivo, 'nombre email role estado google')
            .skip(desde)
            .limit(limite)
            .exec((err, usuarios) =>{
...
app.put('/usuario/:id', [verificaToken, vericaAdmin_Role], function (req, res) {
...
app.delete('/usuario/:id', [verificaToken, vericaAdmin_Role], function (req, res) {
